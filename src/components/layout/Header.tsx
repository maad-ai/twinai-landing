  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled
          ? 'backdrop-blur-xl bg-[#0F0F23]/90 border-b border-white/8 shadow-lg shadow-black/20'
        ...
        >
          {navLinks.map((link) => (
            <a
              ...
              className="block py-3 text-[#94A3B8] hover:text-white transition-colors duration-200 text-sm font-500 border-b border-white/5 last:border-0"
            >
              {link.label}
            </a>
          ))}
